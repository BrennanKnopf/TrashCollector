...
def index(request):
    ...
    try:
        ...
        calendar_date = date.today() #creates a numeric date to deal with filtering one day pickup and service suspension
        day_of_week = date.today().strftime("%A") #creates a string for the day of the week associated with todays date.
        ...
        context = {
            ...
            'trash_unpicked': trash_unpicked, #final list used in html to print names scheduled for pick up that day
        }
